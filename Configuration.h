...
#define STRING_CONFIG_H_AUTHOR "(Josef baltz, Anycubic Mega Zero with TriGorilla and Heated bed)" // Who made the changes.
...
//Above line may need to be re-enabled configuration pulled from 4MAX
